...
class ModelArguments:
    ...
    train_in_8bit: Optional[bool] = field(
        ...
        metadata={
            "help": (
                "Train with bitsandbytes 8bit quantized model or not."
                "set True will benefit LLM RAM consumption but decrease train/inference speed."
            )
        }
    )
...
def main():
    ...
    if model_args.model_name_or_path:
        ...
        model = AutoModelForCausalLM.from_pretrained(
            ...
            device_map="auto" if model_args.train_in_8bit else None
        )
    ...
    if training_args.do_train:
        ...
        tokenizer.save_pretrained(training_args.output_dir) # Saves the tokenizer too for easy upload
